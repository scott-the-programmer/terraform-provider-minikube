...
var (
	clusterSchema = map[string]*schema.Schema{
		...
		"base_image": {
			...
			Default: "gcr.io/k8s-minikube/kicbase:v0.0.49@sha256:e6daddbb1dc09ccd195c5605f65e2d38406c36ef36c5a492ffe805d9d36f4945",
		},
		...
		"disable_coredns_log": {
			Type:        schema.TypeBool,
			Description: "If set, disable CoreDNS verbose logging. Defaults to false.",
		...
		"extra_disks": {
			Type:        schema.TypeInt,
			Description: "Number of extra disks created and attached to the minikube VM (currently only implemented for hyperkit, kvm2, qemu2, vfkit, and krunkit drivers)",
		...
		"kubernetes_version": {
			Type:        schema.TypeString,
			Description: "The Kubernetes version that the minikube VM will use (ex: v1.2.3, 'stable' for v1.35.0, 'latest' for v1.35.0). Defaults to 'stable'.",
		...
		"mount": {
			Type:        schema.TypeBool,
			Description: "Kept for backward compatibility, value is ignored.",
