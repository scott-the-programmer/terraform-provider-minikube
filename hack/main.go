...
func main() {
	...
	cc := config.ClusterConfig{
		...
		MinikubeISO:             "https://github.com/kubernetes/minikube/releases/download/v1.31.1/minikube-v1.31.1-amd64.iso",
	...
	minikubeClient := service.NewMinikubeClient(
		service.MinikubeClientConfig{
			...
			ClusterName:     "terraform-provider-minikube-acc",
			Addons:          []string{},
			IsoUrls:         []string{"https://github.com/kubernetes/minikube/releases/download/v1.31.1/minikube-v1.31.1-amd64.iso"},
			NativeSsh:       true,
